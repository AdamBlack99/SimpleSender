...
#include <memory>
#include "../../SimpleSender/Models/model.h"
...
QT_MOC_LITERAL(1, 6, 10), // "gotMessage"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 11), // "std::string"
QT_MOC_LITERAL(4, 30, 7) // "message"

    },
    "Model\0gotMessage\0\0std::string\0message"
};
...
void Model::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gotMessage((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Model::gotMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Model::gotMessage(std::string _t1)
{
